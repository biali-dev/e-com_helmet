                    ...
                    <div style={emptyWrapStyle}>
                        <div style={emptyCardStyle}>
                            ...
                            <div style={{ marginTop: 14, display: "flex", gap: 10, flexWrap: "wrap" }}>
                                <Link to="/" style={{ ...btnStyle, ...btnPrimaryStyle, display: "inline-block" }}>
                                    Ir para a loja
                                </Link>

                                <Link to="/" style={{ ...btnStyle, ...btnGhostStyle, display: "inline-block" }}>
                                    Ver destaques
                                </Link>
                            </div>
                        </div>
                                            ...
                                            <div style={{ display: "flex", gap: 12, alignItems: "center", minWidth: 0 }}>
                                                ...
                                                <div style={{ minWidth: 0 }}>
                                                    ...
                                                    <div style={metaStyle}>
                                                        ...
                                                        <Link to={`/produto/${i.slug}`} style={miniLinkStyle}>ver produto</Link>
                                                    </div>
                                                </div>
                                            </div>
...
/* ------------------ styles (same language as Checkout) ------------------ */
...
const itemBottomRowStyle: React.CSSProperties = {
    marginTop: 12,
    display: "flex",
    justifyContent: "space-between",
    alignItems: "center",
